...
public class StringMatching<T> {
        ...
        /**
         * Find pattern in text returning the positions of each occurrence of pattern in text
         * @param pattern
         * @param text
         * @return
         */
        public ArrayList<Integer> find(String pattern, String text){
        	return search(text, new String[]{pattern})[0];
        }
        /**
         * Find patterns in text returning the positions of each of the occurrences of all the patterns in text
         * @param pattern
         * @param text
         * @return
         */
        public ArrayList<Integer>[] find(String[] patterns, String text){
         ...
         * @param s
         */
        private void treeConstruct(String[] s){
         ...
         */
        private ArrayList<Integer>[] search(String text, String[] s){
